        ...
        <nav class="nav">
            <div><a href="#" class="nav_logo"><i class='bx bxs-map text-dark fw-bold'></i><span class="nav_logo-name text-dark fw-bold">Smkn 4 Tasikmalaya</span> </a>
                <div class="nav_list"> <a href="dashboard.php" class="nav_link active">
                   ...
                   <a href="riwayat_proses.php" class="nav_link"> <i class='bx bx-food-menu'></i> <span class="nav_name">process history</span></a> 
                   <a href="riwayat_selesai.php" class="nav_link"> <i class='bx bxs-food-menu'></i> <span class="nav_name">History complete</span></a> 
                   <a href="user.php" class="nav_link"> <i class='bx bxs-user-account'></i> <span class="nav_name">User Account</span></a> 
                 </div>
