...
//koneksi database
$hasil = mysqli_query($koneksi,"select * from tb_absen WHERE status='rejected'  ORDER BY tgl ASC ");
...
<nav class="nav nav-borders">
        <a class="nav-link text-primary" href="riwayat.php" target="__blank">presence rejected</a>
    </nav>
    <hr class="mt-0 mb-4">
    <div class="card">
        <br>
  ...
  <div>
   ...
   <input type="search" class="form-control light-table-filter" style="width:200px" data-table="table-striped" placeholder="Mencari..." />
    ...
    ?>
            ...
            <th scope="row">
                <button type="button" class="btn btn-danger text-light fw-bold"><?= $tampil["status"];?></button>
            </th>
            <!-- <td>
