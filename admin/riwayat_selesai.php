...
//koneksi database
$hasil = mysqli_query($koneksi,"select * from tb_absen WHERE status='success' ORDER BY tgl ASC");
...
<nav class="nav nav-borders">
        <a class="nav-link text-primary" href="riwayat.php" target="__blank">successful attendanc</a>
    </nav>
    <hr class="mt-0 mb-4">
    <div class="card">
        <br>
