    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2" src="assets/upload/<?= $tampil["img"];?>" alt="">
                    <div class="small font-italic text-muted mb-4">JPG or PNG images cannot be larger than 5 MB</div>
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="pro_profile.php" enctype="multipart/form-data">
                        <!-- Form Group (username)-->
                            <input name="id_user" type="hidden" value="<?= $tampil["id_user"];?>">
                        <div class="mb-3">
