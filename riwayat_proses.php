...
//koneksi database
$hasil = mysqli_query($koneksi,"select * from tb_absen where email='$email' AND status='proses' ");
...
<nav class="nav nav-borders">
    ...
    ?>
            ...
            <th scope="row">
                <button type="button" class="btn btn-warning text-light fw-bold"><?= $tampil["status"];?></button>
            </th>
            <!-- <td>
